#!/usr/bin/env node
/**
 * Bin shim for `cli-quality-corpus` (AISDLC-270 / RFC-0025 Phase 5).
 ...
 * that recurred within 30 days, per OQ-3), and coverage rate (fraction of
 * captures classified vs. ambiguous).
 *
